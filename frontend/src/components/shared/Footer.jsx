      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm">© 2024 Amit Verma . All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://github.com/Amit-Verma5262" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://x.com/AmitVerma7062" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/amit-verma-1b5677249/" className="hover:text-gray-400" aria-label="LinkedIn">
